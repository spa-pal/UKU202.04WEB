 ...
 *---------------------------------------------------------------------------*/
 ...
 MIB_ENTRY snmp_mib[] = {
  ...
  /* SysObjectID Entry */
  { MIB_OBJECT_ID | MIB_ATR_RO,	     8, {OID0(1,3), 6, 1, 2, 1, 1, 2, 0},	    MIB_STR("\x2b\x06\x01\x04\x01\x82\x83\x1f\x0A\x01")/*MIB_STR("\x2b\x06\x01\x04\x01\x82\x83\x1F")*/,    NULL },
  /* SysUpTime Entry */
  ...
  /* ---------- Experimental MIB ----------- */
	...
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BAT, DISPLAY_BAT_VOLTAGE, 0},  				MIB_INT(snmp_bat_voltage),  	NULL},	//Номер БПСа
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BAT, DISPLAY_BAT_CURRENT, 0},  				MIB_INT(snmp_bat_current),  	NULL},	//Номер БПСа
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BAT, DISPLAY_BAT_TEMPERATURE, 0},  			MIB_INT(snmp_bat_temperature),NULL},	//Номер БПСа
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BAT, DISPLAY_BAT_CAPACITY, 0},  				MIB_INT(snmp_bat_capacity),  	NULL},	//Номер БПСа
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BAT, DISPLAY_BAT_CHARGE, 0},  				MIB_INT(snmp_bat_charge),  	NULL},	//Номер БПСа
	{ MIB_INTEGER | MIB_ATR_RO,  	12, {OID_ENTERPRISE, OID_DEVICE, DISPLAY_BAT, DISPLAY_BAT_STATUS, 0},  				MIB_INT(snmp_bat_status),  	NULL},	//Номер БПСа
...
//	{ MIB_INTEGER, 			12, {OID_ENTERPRISE, OID_DEVICE, 8, 1, 0},   MIB_INT(snmp_bpsnumber[0]),    NULL},
 ...
 /* { MIB_INTEGER | MIB_ATR_RO,  	13, {OID0(1,3), 6, 1, 4, 1, 130, 131, 31, 2, 2, 3, 1, 0},  MIB_INT(plazma_mib),  NULL},
  ...
  { MIB_INTEGER,  	13, {OID0(1,3), 6, 1, 4, 1, 130, 131, 31, 1, 2, 1, 2, 0},    MIB_INT(LPC_RTC->SEC),    NULL}, */
	...
	{ MIB_INTEGER,  			12, {OID_ENTERPRISE, OID_DEVICE, SYSPARAMS, SYSPARAMS_KIMAX, 0},						MIB_INT(snmp_min_current),	snmp_min_current_write},		//номер первого бпса 
