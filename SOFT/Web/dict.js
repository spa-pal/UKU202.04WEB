var set_dict = [
	...
	["Мнемоника.","Задержка включения мнемонической диаграммы на дисплее УКУ после последнего нажатия на кнопки.","","ONOFF","RADIOINPUT","",["ВЫКЛ.","10сек.","30сек.","60сек.","5мин."],"mnemo_____",5],
	...
	["Основной источник","Номер источника находящегося в постоянной работе","","INT","INTINPUT","",[1,2],"main_bps_",3],
	...
	["Синхронизация по SNTP","Включенность/период автоматической синхронизация времени и даты по серверу SNTP. Для правильного выполнения процедуры необходимо корректно установить часовой пояс","","STRING","RADIOINPUT","",["ВЫКЛ.","1 час","1 сутки","1 неделя"],"sntp_en_",34],
