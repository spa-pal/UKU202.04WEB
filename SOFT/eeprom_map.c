...
const short ADR_T_EXT_RS_EN[3]={EE_T_EXT_RS_EN0,EE_T_EXT_RS_EN1,EE_T_EXT_RS_EN2};
...
const short ADR_SK_RS_EN[4]={EE_SK_RS_EN0,EE_SK_RS_EN1,EE_SK_RS_EN2,EE_SK_RS_EN3};
